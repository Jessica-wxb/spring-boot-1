 ...
 * @author Jessica
 * @version 1.0.0
 * @ClassName SampleCrudTest.java
 * @Description
 * <p>
 *     内置CRUD
 *
 * </p>
 * @createTime 2020年03月20日 10:38:00
 */
...
public class SampleCrudTest {
    ...
    @Test
    public void bDelete() {
        Assertions.assertThat(mapper.deleteById(5)).isGreaterThan(0);
        Assertions.assertThat(mapper.delete(new QueryWrapper<User>()
                .lambda().eq(User::getName, "Jessica"))).isGreaterThan(0);
    ...
    @Test
    public void cUpdate() {
        Assertions.assertThat(mapper.updateById(new User().setId(1).setEmail("ab@c.c"))).isGreaterThan(0);
